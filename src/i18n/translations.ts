...
export const fr: Translations = {
  ...
  hero: {
    ...
    desc: "Ingénieur logiciel, diplomé de Polytechnique Montréal, passionné en développement web & mobile. Spécialisé en <strong>TypeScript, Angular, React</strong>. J'aime créer des produits performants et des expériences utilisateurs mémorables.",
...
export const en: Translations = {
  ...
  hero: {
    ...
    desc: 'Software engineer graduate of Polytechnique Montreal, Passionate with web & mobile development. Specialized in <strong>TypeScript, Angular, React</strong>. I love building high-performance products and memorable user experiences.',
